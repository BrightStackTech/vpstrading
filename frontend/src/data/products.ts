...
export const categories = [
  ...
  {
    name: 'Personal care and toiletries',
    image: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&q=80&w=800',
    description: 'Beauty, grooming, and hygiene essentials'
  },
  {
    name: 'Spreads',
    image: 'https://manoramagroup.co.in/img/product/chocolate/Spreads.jpg',
    description: 'Delicious spreads and cream products'
  },
  {
    name: 'Tea and coffee',
  ...
  },
  {
    ...
    description: 'Chips, crisps, and savory treats'
  }
];
...
export const products: Product[] = [
  // Confectionery
  {
    ...
    "category": "Personal care and toiletries",
